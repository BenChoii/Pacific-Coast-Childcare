...
async function invokeMutation(func, argsStr, visibility) {
  ...
  const mutationCtx = {
    ...
    runQuery: (reference, args2, options) => runUdf("query", reference, args2, options == null ? void 0 : options.transactionLimits),
    runSnapshotQuery: (reference, args2, options) => runUdf("snapshotQuery", reference, args2, options == null ? void 0 : options.transactionLimits),
...
async function invokeAction(func, requestId, argsStr, visibility) {
  var _a, _b;
  (_b = (_a = globalThis.Convex) == null ? void 0 : _a.setupPerformance) == null ? void 0 : _b.call(_a);
  const args = jsonToConvex(JSON.parse(argsStr));
